...
class ExploreAdapter : RecyclerView.Adapter<ExploreAdapter.ExploreViewHolder>() {
    ...
    private var exploreList = listOf<ListExploreResult>()
    private var filteredExplores: List<ListExploreResult> = listOf()
    ...
    fun submitList(list: List<ListExploreResult>) {
        exploreList = list
    ...
    class ExploreViewHolder(private val binding: ItemDestinationBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(exploreItem: ListExploreResult) {
